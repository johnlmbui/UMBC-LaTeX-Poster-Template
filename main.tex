...
\institute{
\inst{1} Department of Mathematics and Statistics, University of Maryland, Baltimore County
\samelineand
...
\addtobeamertemplate{headline}{}
{
    ...
    %   {\includegraphics[height=5.0cm]{stanford_logos/Stanford-CS.png}}; % uc-logo-white.eps
      \node [anchor=north east, inner sep=3.0cm] at ([xshift=0.0cm,yshift=0.5cm]current page.north east)
